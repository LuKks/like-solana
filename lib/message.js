...
class CompiledKeys {
  ...
  extractTableLookup (lookupTable) {
    const [writableIndexes, writableKeys] = this.drainKeysFoundInLookupTable(
      lookupTable.state.addresses,
      keyMeta => !keyMeta.isSigner && !keyMeta.isInvoked && keyMeta.isWritable
    )

    const [readonlyIndexes, readonlyKeys] = this.drainKeysFoundInLookupTable(
      lookupTable.state.addresses,
      keyMeta => !keyMeta.isSigner && !keyMeta.isInvoked && !keyMeta.isWritable
    )
...
module.exports.MessageAccountKeys = MessageAccountKeys
module.exports.CompiledKeys = CompiledKeys
